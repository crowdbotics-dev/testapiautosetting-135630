...
class Testconnectors135630ViewSet(BaseConnectorViewSet):
    PASSWORD = settings.CONNECTOR_TESTCONNECTORS135630_PASSWORD
    USERNAME = settings.CONNECTOR_TESTCONNECTORS135630_USERNAME
    BASE_URL = "https://devstringx.com"
    AUTH_TYPE = "basic"
    IDENTIFIER = "CONNECTOR_TESTCONNECTORS135630"
